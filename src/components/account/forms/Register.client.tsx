  ...
  return (
    <div className="my-24 flex justify-center px-4">
      <FormCardWrapper title="Register">
        <p className='text-sm font-nhaasReg mb-7'>
          Receive the latest on sales, deals and more. You are registering for the Varley site servicing worldwide, excluding NA.
        </p>
