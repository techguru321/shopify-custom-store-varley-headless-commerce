...
import type {ProductWithNodes, SanityColorTheme, SanityCustomProductOption} from '../../types';
    ...
    >
      ...
      >
        {products.map((product) => (
          <ProductCard key={product.id} storefrontProduct={product} customProductOptionColors={customProductOptions[0].colors}/>
        ))}
      </div>
    </div>
  );
