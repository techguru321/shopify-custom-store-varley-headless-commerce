...
export default function ProductHotspot({storefrontProduct, x, y}: Props) {
  ...
  return (
    ...
    >
      <Link
        className={clsx(
          'absolute left-[50%] top-[50%] flex h-[26px] w-[26px] -translate-x-1/2 -translate-y-1/2 animate-pulse items-center justify-center rounded-full bg-black duration-300 ease-out',
